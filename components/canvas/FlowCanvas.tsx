    ...
    <div style={{
        ...
        return (
          <div
            ...
            style={{
              ...
              background: isFailed ? (theme === 'dark' ? '#1a0808' : '#fef2f2') : (theme === 'dark' ? '#1a0d04' : '#fffbeb'),
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <span style={{
                fontSize: 11, color: isFailed ? '#ef4444' : '#f59e0b',
                fontFamily: 'monospace', fontWeight: 700,
              }}>
                {isFailed ? '✕ FAILED' : '⚠ OVERLOADED'}
              </span>
              <span style={{
                fontSize: 11, color: t.textPrimary, fontFamily: 'monospace', marginLeft: 8,
              }}>
                {n.data.label}
              </span>
              <span style={{
                fontSize: 10, color: t.textMuted, fontFamily: 'monospace', marginLeft: 6,
              }}>
                {util}% load
              </span>
            </div>
      ...
      {overloaded.length > 4 && (
        <div style={{
          ...
          background: theme === 'dark' ? '#1a0808' : '#fef2f2', border: '1px solid #ef444430',
          borderRadius: 8,
        }}>
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          color: t.textSecondary, fontFamily: 'monospace', fontWeight: 700,
          textTransform: 'uppercase', letterSpacing: '0.08em',
          borderBottom: `1px solid ${t.border2}`, marginBottom: 4,
        }}>
          {node.data.label}
        </div>
        {menuItems.map(item => (
...
function CanvasToolbar() {
  ...
  const btnStyle = (disabled: boolean, color: string): React.CSSProperties => ({
    ...
    border: `1px solid ${disabled ? t.border2 : `${color}50`}`,
    borderRadius: 6,
  ...
  return (
    <div style={{
      ...
      background: theme === 'dark' ? '#080d1490' : 'rgba(255,255,255,0.85)', backdropFilter: 'blur(12px)',
  ...
  return (
    <div style={{
      ...
      <div
        ...
        style={{
          background: t.surface, border: '1px solid #f59e0b50',
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: t.textSecondary, fontFamily: 'monospace', marginTop: 2 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <input
              ...
              style={{
                ...
                border: `1px solid ${msg ? '#ef444450' : t.border2}`,
                borderRadius: 8, padding: '10px 14px',
                color: t.textPrimary, fontSize: 13, fontFamily: 'monospace',
                outline: 'none', transition: 'border-color 0.15s',
              }}
              onFocus={e => { (e.target as HTMLInputElement).style.borderColor = '#f59e0b50'; }}
              onBlur={e => { (e.target as HTMLInputElement).style.borderColor = msg ? '#ef444450' : t.border2; }}
            />
            <button
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 8, padding: '10px 0', color: t.textSecondary,
    ...
    <>
      ...
      >
        ...
        <ReactFlow
          ...
          connectionLineStyle={{ stroke: t.accent, strokeWidth: 2, strokeDasharray: '4 3' }}
          connectionLineType={ConnectionLineType.Bezier}
        >
          <Background
            variant={BackgroundVariant.Dots}
            gap={28} size={1} color={theme === 'dark' ? '#1e2d3d55' : '#e5e7eb'}
          />
          <Controls
          ...
          <MiniMap
            ...
            nodeColor={(node) => {
              ...
              return cfg?.color?.border ?? t.border2;
            }}
            maskColor={theme === 'dark' ? '#050811cc' : '#f8fafccc'}
          />
