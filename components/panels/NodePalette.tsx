...
export default function NodePalette({ embedded }: { embedded?: boolean }) {
  ...
  return (
    <div style={{ background: t.surface, display: 'flex', flexDirection: 'column', height: '100%', width: '100%' }}>
      ...
      {/* Search */}
      <div className="panel-section" style={{ padding: '10px 12px', flexShrink: 0, borderBottom: `1px solid ${t.border}` }}>
      ...
      <div style={{ overflowY: 'auto', flex: 1, padding: '4px 0' }}>
        {results.length === 0 ? (
          <div style={{
            ...
            color: t.textMuted, fontFamily: 'var(--font-ui)',
            fontSize: 13,
          }}>
      ...
      <div style={{
        ...
        {!isPremium ? (
          ...
          <span>
            Drag to canvas ·{' '}
            <span style={{ color: t.textSecondary, fontFamily: 'var(--font-mono)' }}>
...
function NodeItem({ cfg, hovered, onHover, onDragStart, isPremium, t }: {
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{
          ...
          color: hovered ? nc.text : t.textPrimary,
          fontFamily: 'var(--font-ui)',
        ...
        <div style={{
          fontSize: 11, color: hovered ? t.textSecondary : t.textMuted,
